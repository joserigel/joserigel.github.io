  ...
  return (<>
    ...
    <article>
      <div className='card'>
        ...
        <p>
          I'm currently looking for new challenges in Software Engineering, specifically in Working Student positions or Full Time Internships. During my second and third semester of my study, I worked in the automotive industry as part time Full-Stack Software Developer.
        </p>
        <p>
